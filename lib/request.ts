...
export const SERVICE_AREAS = [
  ...
  { id: 'llm', title: 'Local LLMs & RAG', keywords: 'ollama assistant retrieval augmented generation embeddings chunking prompt offline ai agent' },
  { id: 'vectordb', title: 'Vector search & embeddings', keywords: 'vector database qdrant chroma faiss pgvector milvus weaviate similarity semantic search index rag' },
  { id: 'databases', title: 'Databases & storage', keywords: 'postgresql postgres mongodb sqlite schema migrations queries indexing files filesystem backup sqlcipher' },
